...
export default async function BlogPostPage({ params }: BlogPostPageProps) {
  ...
  const recentPosts =
    relatedPosts.length > 0 ? relatedPosts : getRecentBlogPosts(3);
    ...
    switch (componentName) {
      case "pageHeader":
        return (
          <div
            key={componentName}
            className="bg-gradient-to-r from-emerald-600 to-blue-600 text-white py-12"
          >
      ...
      case "content":
        return (
          <div key={componentName}>
            ...
            {/* Article Content */}
            <div id="article-content" className="py-12">
              <div className="container mx-auto px-4">
                <div className="max-w-4xl mx-auto">
      ...
      case "tags":
        return (
          <div id="tags" key={componentName} className="py-8 bg-muted/30">
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto">
      ...
      case "authorBio":
        return (
          <div id="author" key={componentName} className="py-12 bg-muted/50">
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto">
                <div className="flex items-start gap-6 p-6 bg-white rounded-lg shadow-sm">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground mb-4">
                      {post.author.bio ||
                        `${post.author.name} is a gaming enthusiast and content creator with extensive experience in the gaming industry.`}
                    </p>
                  </div>
                </div>
              </div>
      ...
      case "newsletter":
        return (
          <div
            key={componentName}
            className="py-16 bg-gradient-to-r from-blue-600 to-emerald-600 text-white"
          >
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-xl opacity-90 mb-8">
                  {config.subtitle ||
                    "Get the latest gaming news and articles delivered to your inbox"}
                </p>
      ...
      case "relatedArticles":
        ...
        return (
          <div id="related" key={componentName} className="py-16">
            <div className="container mx-auto px-4">
